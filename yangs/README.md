...
# ln -s ietf-yang-push-revision-07.yang ietf-yang-push-revision.yang
$ pyang -f tree ietf-yang-push-revision@2025-08-20.yang ietf-system-capabilities.yang ietf-notification-capabilities.yang --tree-line-length=69 -p dependencies
$ pyang ietf-yang-push-revision@2025-08-20.yang -f tree -p dependencies --tree-line-length=69
$ pyang -f tree ietf-yang-push-revision@2025-08-20.yang ietf-yang-push@2019-09-09.yang ietf-subscribed-notifications@2019-09-09.yang --tree-line-length=69 -p dependencies
```