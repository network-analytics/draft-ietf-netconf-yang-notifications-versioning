...
$ pyang -f tree ietf-yang-push-revision@2026-07-02.yang ietf-system-capabilities.yang ietf-notification-capabilities.yang --tree-line-length=69 -p dependencies
$ pyang ietf-yang-push-revision@2026-07-02.yang -f tree -p dependencies --tree-line-length=69
$ pyang -f tree ietf-yang-push-revision@2026-07-02.yang ietf-yang-push@2019-09-09.yang ietf-subscribed-notifications@2019-09-09.yang --tree-line-length=69 -p dependencies
```
